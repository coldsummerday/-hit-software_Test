...
class Lunar:
    def __init__(self, lunarYear, lunarMonth, lunarDay, isleap):
        ...
        self.monthCn=['正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '腊']
        self.dateCn =  ['初一', '初二', '初三', '初四', '初五', '初六', '初七', '初八', '初九', '初十', '十一', '十二', '十三', '十四', '十五', '十六', '十七', '十八', '十九', '二十', '廿一', '廿二', '廿三', '廿四', '廿五', '廿六', '廿七', '廿八', '廿九', '三十', '卅一']

    def heaven_Year(self):

        heavenIndex = int((self.lunarYear - 3) % 10)-1
        earchIndex = int((self.lunarYear - 3) % 12)-1
        self.heavenYear = self.heavenlysStems[heavenIndex] + self.earthlyBranches[earchIndex]+self.zodiac[earchIndex]
    ...
    def __str__(self):
        ...
        return "".join([self.heavenYear,"年",self.monthCn[self.lunarMonth-1],"月",self.dateCn[self.lunarDay-1]])
